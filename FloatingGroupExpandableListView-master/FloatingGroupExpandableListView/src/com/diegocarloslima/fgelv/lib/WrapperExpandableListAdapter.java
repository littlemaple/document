...
public class WrapperExpandableListAdapter extends BaseExpandableListAdapter {
	...
	public WrapperExpandableListAdapter(Context context, ExpandableListAdapter adapter) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		if (convertView != null) {
			final Object tag = convertView.getTag(ReflectionUtils.getId(context, "fgelv_tag_changed_visibility"));
			...
			convertView.setTag(ReflectionUtils.getId(context, "fgelv_tag_changed_visibility"), null);
		}
